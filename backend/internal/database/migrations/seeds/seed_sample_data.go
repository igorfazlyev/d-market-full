...
func SeedSampleData(db *gorm.DB) error {
	...
	if err := db.Create(clinic1User).Error; err != nil {
	...
	if err := db.Create(clinic1).Error; err != nil {
	...
	if err := db.Create(clinic2User).Error; err != nil {
	...
	if err := db.Create(clinic2).Error; err != nil {
	...
	if err := db.Create(regulatorUser).Error; err != nil {
	...
	if err := db.Create(regulator).Error; err != nil {
	...
	if err := db.Create(&priceListClinic1).Error; err != nil {
		return fmt.Errorf("failed to create price list for clinic1: %w", err)
	}
	if err := db.Create(&priceListClinic2).Error; err != nil {
	...
	if err := db.Create(scan1).Error; err != nil {
	...
	if err := db.Create(scan2).Error; err != nil {
	...
	if err := db.Create(&treatmentItems).Error; err != nil {
	...
	if err := db.Create(offer1).Error; err != nil {
	...
	if err := db.Create(offer2).Error; err != nil {
	...
	for i := 90; i >= 0; i-- {
		...
		if err := db.Create(regionalStats).Error; err != nil {
		...
		if err := db.Create(clinic1Stats).Error; err != nil {
		...
		if err := db.Create(clinic2Stats).Error; err != nil {
